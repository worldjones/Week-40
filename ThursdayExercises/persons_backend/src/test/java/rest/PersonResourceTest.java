...
public class PersonResourceTest {
    ...
    public void setUp() {
        ...
        p1.setAddress(new Address("Virumbakken 1", 2830, "Virum"));
        p2.setAddress(new Address("Lyngbyhovedgade", 2800, "Lyngby"));
        p3.setAddress(new Address("Jagtvej 99", 1050, "København"));
    ...
    public void testAddPerson() throws Exception {
        given()
                .contentType("application/json")
                .body(new PersonDTO("Bob", "Bobsen", "21212121", "Gade 42", 3334, "Lyngby"))
                .when()
                .post("person")
                .then()
                .body("fName", equalTo("Bob"))
                .body("lName", equalTo("Bobsen"))
                .body("phone", equalTo("21212121"))
                .body("street", equalTo("Gade 42"))
                .body("zip", equalTo(3334))
                .body("city", equalTo("Lyngby"))
    ...
    public void testAddPersonException() {
        given()
                .contentType("application/json")
                .body(new PersonDTO("Bob", "", "21212121", "Gade 42", 3334, "Lyngby"))
                .when()
                .post("person")
                .then()
                .assertThat()
